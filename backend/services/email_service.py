...
SENDER_EMAIL = "SpeakIQ <onboarding@resend.dev>" # Resend testing email
    ...
    try:
        ...
        if email_type == "reminder":
            ...
            <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; background-color: #0f1115; color: #ffffff; padding: 40px; border-radius: 16px; border: 1px solid #1f2937;">
                ...
                <a href="https://speakiq.app/dashboard" style="display: inline-block; background-color: #10b981; color: #000000; font-weight: bold; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-size: 16px;">Record a 60s Session Now</a>
                <p style="margin-top: 40px; font-size: 12px; color: #6b7280;">You can manage your notification preferences in your SpeakIQ Settings.</p>
            </div>
            """
            ...
            <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; background-color: #0f1115; color: #ffffff; padding: 40px; border-radius: 16px; border: 1px solid #f59e0b33;">
                ...
                <a href="https://speakiq.app/dashboard" style="display: inline-block; background-color: #f59e0b; color: #000000; font-weight: bold; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-size: 16px;">Keep the Streak Alive</a>
            </div>
            """
